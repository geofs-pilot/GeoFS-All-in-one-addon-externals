...
async function spawnHTML() {
    ...
    let _0x5a899e = document[_0x2d42f7(0x196)](_0x2d42f7(0x187));
    _0x5a899e[_0x2d42f7(0x137)] = _0x2d42f7(0x109);

    // ✅ FIX: Force inline-flex so it doesn't overwrite the right side of the bar
    _0x5a899e['style']['display'] = 'inline-flex';
    _0x5a899e['style']['alignItems'] = 'center';
    _0x5a899e['style']['width'] = 'auto';
    _0x5a899e['style']['marginRight'] = '4px';

    // ✅ Append button to bottom bar (instead of body)
    document[_0x2d42f7(0x10c)](_0x2d42f7(0x173))[0x0]['appendChild'](_0x5a899e);
